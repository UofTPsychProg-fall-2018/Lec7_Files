...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.00), Mon 14 Jan 11:06:36 2019
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/katherineduncan/Desktop/GradProgramming/dev/counterB/Stroop/stroop.psyexp',
...
instrText = visual.TextStim(win=win, ori=0, name='instrText',
    text='press "r" for red, "b" for blue and "g" for green',    font='Arial',
...
thanksText = visual.TextStim(win=win, ori=0, name='thanksText',
    text='This is the end of the experiment',    font='arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
    color=[1, 1, 1], colorSpace='rgb', opacity=1,
    depth=0.0)
...
trials_2 = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/katherineduncan/Desktop/GradProgramming/dev/counterB/Stroop/stroop.psyexp',
    trialList=data.importConditions(str(int(expInfo['participant'])%2+1) + "PickBlocks.csv"),
...
for thisTrial_2 in trials_2:
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if resp.status == STARTED:
                ...
                if len(theseKeys) > 0:  # at least one key was pressed
                    ...
                    # was this 'correct'?
                    if (resp.keys == str(corResp)) or (resp.keys == corResp):
                        resp.corr = 1
                    else:
                        resp.corr = 0
                    # a response ends the routine
        ...
        if resp.keys in ['', [], None]:  # No response was made
           ...
           if str(corResp).lower() == 'none': resp.corr = 1  # correct non-response
